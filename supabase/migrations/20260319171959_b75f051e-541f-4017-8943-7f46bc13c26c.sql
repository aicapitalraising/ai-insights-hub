...
CREATE POLICY "Public can view clients by token" ON public.clients FOR SELECT USING (public_token IS NOT NULL);
CREATE POLICY "Public can view daily_metrics" ON public.daily_metrics FOR SELECT USING (true);
CREATE POLICY "Public can view funded_investors" ON public.funded_investors FOR SELECT USING (true);
CREATE POLICY "Service role full access to clients" ON public.clients FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access to daily_metrics" ON public.daily_metrics FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access to leads" ON public.leads FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access to calls" ON public.calls FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access to funded_investors" ON public.funded_investors FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access to sync_logs" ON public.sync_logs FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service role full access to alert_configs" ON public.alert_configs FOR ALL USING (true) WITH CHECK (true);
...
CREATE TRIGGER calculate_funded_metrics_trigger BEFORE INSERT OR UPDATE ON public.funded_investors FOR EACH ROW EXECUTE FUNCTION public.calculate_funded_metrics();