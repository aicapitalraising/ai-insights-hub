...
import { StyleSelection } from '@/components/static-batch/steps/StyleSelection';
import { ProjectSetup } from '@/components/static-batch/steps/ProjectSetup';
import { GenerationConfig } from '@/components/static-batch/steps/GenerationConfig';
import { ResultsGallery } from '@/components/static-batch/steps/ResultsGallery';
...
export function StaticGenTab({ clientId, clientName }: StaticGenTabProps) {
  ...
  const { generateAds } = useStaticBatchGeneration({
    ...
    styles,
    client,
    projectOfferDescription: editableOffer || client?.offer_description,
    setGeneratedAds,
    setIsGenerating,
  });
